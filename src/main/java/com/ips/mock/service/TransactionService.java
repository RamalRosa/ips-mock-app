...
public class TransactionService {
    ...
    public TransactionService(AccountStorageService accountStorageService, BankStorageService bankStorageService) {
        this.accountStorageService = accountStorageService;
        this.bankStorageService = bankStorageService;
    }

    public ResponseEntity<DefaultResponse> processTransaction(CreditTransferRequest request){
        try {
